...
#      assert_equal @bob_details, @vault[vault_path].reject {|k,v| [:modifier,:association].include? k}
  ...
  def test_vault_to_client
    ...
    assert_not_nil ::RubySyncEvent.find_by_event_type('modify'), "No modify event generated"
    @pipeline.run_once
  ...
  def test_fields
    assert_equal(%w{id first_name last_name}.sort, ::ArActiveRecordConnector.fields.sort)
  end
